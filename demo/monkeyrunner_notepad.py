...
device.startActivity(component="cn.nubia.notepad.preset/cn.nubia.notepad.NoteListActivity")
# 打印操作信息
log.write("启动app……\n")
# 等待2秒
...
# 点击的位置坐标。
device.touch(440, 1780, 'DOWN_AND_UP')
# MonkeyRunner.sleep(5)
# 输入72082645字样
device.type("72082645")
device.touch(250, 1860, 'DOWN_AND_UP')
# 截图
result1 = device.takeSnapshot()
# 保存截图
result1.writeToFile(path + "个人页".decode('utf-8') + now + '.png', 'png')
#点击确定保存
device.touch(940, 160, 'DOWN_AND_UP')



# 下面就开始对之前的截图进行对比了
# 第一张截图做对比，去文件中找到我们要对比的图片
resultTrue = MonkeyRunner.loadImageFromFile('D:\\picture2\\shottrue2.png')
log.write("主页面对比图片……\n")
# 判断图片相识度是否是为90%
...
# 去文件中找到我们规定的图片用来对比
result1True = MonkeyRunner.loadImageFromFile('D:\\picture2\\shottrue3.png')
# 判断图片相识度是否是为90%
